...
if __name__ == "__main__":
    # --- CONFIGURATIONS ---
    TARGET_FPS = 15 # Cap the main loop to this framerate
    ...
    with vision.PoseLandmarker.create_from_options(pose_options) as pose_detector, \
        ...
        while cap.isOpened():
            ...
            # Run gesture recognition only on even frames to save resources
            ...
            wait_time_ms = max(1, int((FRAME_DURATION - elapsed_time) * 1000))
